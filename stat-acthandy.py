...
def parse_asm(
    ...
    for lineno, line in enumerate(lines):
        ...
        if len(parts) == 0:
        ...
        elif len(parts) >= 2 and parts[-1].endswith(',%rsp') and parts[-2] == 'sub':
            fsz = parts[-1].split(',')[0]
            ...
            if any(part == 'callq' for part in parts):
                print(lineno + 1)
                if lineno == 58:
                    continue
                assert False
